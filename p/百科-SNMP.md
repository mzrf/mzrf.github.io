...
![SNMP管理模型](https://download.huawei.com/mdl/image/download?uuid=bf1c40be6acd4111b592a057a9805b41 "SNMP管理模型")  
SNMP管理模型
...
![OID树结构](https://download.huawei.com/mdl/image/download?uuid=31ce195d28f642299a6a275e594bd96e "OID树结构")  
OID树结构
...
![网管通过SNMP协议管理设备示意图](https://download.huawei.com/mdl/image/download?uuid=3fca616071c942bd96a6d884e1cf9b75 "网管通过SNMP协议管理设备示意图")
...
1[SNMP配置（NetEngine AR）](https://support.huawei.com/hedex/hdx.do?docid=EDOC1100087046&id=ZH-CN_TASK_0177878325&lang=zh)

2[华为百科](https://info.support.huawei.com/info-finder/encyclopedia/zh/SNMP.html)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcyMzM3Mzk2OV19
-->